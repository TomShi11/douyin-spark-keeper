...
[![版本](https://img.shields.io/badge/version-1.9.5-fe2c55)](https://github.com/TomShi11/douyin-spark-keeper/releases/latest)
[![Manifest V3](https://img.shields.io/badge/Manifest-V3-4285f4)](https://developer.chrome.com/docs/extensions/mv3/intro/)
[![测试](https://img.shields.io/badge/tests-213%20passed-12a150)](#开发)
...
node --test "tests/*.test.mjs"    # 213 项
